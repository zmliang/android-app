 ...
 * the License.
 *******************************************************************************/
package com.goldplusgold.widget.newpulltorefresh;
...
import com.goldplusgold.widget.newpulltorefresh.internal.CustomLoadingLayout;
import com.goldplusgold.widget.newpulltorefresh.internal.CustomRotateLoadingLayout;
import com.goldplusgold.widget.newpulltorefresh.internal.FlipLoadingLayout;
import com.goldplusgold.widget.newpulltorefresh.internal.LoadingLayout;
import com.goldplusgold.widget.newpulltorefresh.internal.LoadingLayout.OnSuperAddCallback;
import com.goldplusgold.widget.newpulltorefresh.internal.RotateLoadingLayout;
import com.goldplusgold.widget.newpulltorefresh.internal.Utils;
import com.goldplusgold.widget.newpulltorefresh.internal.ViewCompat;
    ...
    protected void updateUIForMode() {
        ...
        if (mMode.showHeaderLoadingLayout()) {
            mHeaderLayout.addSelf(this, 0, lp, new OnSuperAddCallback() {
                ...
                @Override
                public void addView(View view, int index, android.view.ViewGroup.LayoutParams lp) {
        ...
        if (mMode.showFooterLoadingLayout()) {
            mFooterLayout.addSelf(this, -1, lp, new LoadingLayout.OnSuperAddCallback() {
            ...
            switch (this) {
                ...
                case CUSTOM:
                    if (Mode.PULL_FROM_START == mode) {
                        ...
                        return new CustomRotateLoadingLayout(context, mode, scrollDirection, attrs);
                    }
