package com.goldplusgold.widget.pulltorefresh;
...
import com.goldplusgold.widget.pulltorefresh.pullableView.PullAble;
...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            ...
            case REFRESHING:
                // 正在刷新状态
                refreshStateImageView.setImageResource(R.drawable.logo_refreshing);
                AnimationDrawable animationDrawable = (AnimationDrawable) refreshStateImageView.getDrawable();
            ...
            case DONE:
                // 刷新或加载完毕，啥都不做
                refreshStateImageView.setImageResource(R.drawable.logo_refreshing);
                AnimationDrawable animationDrawableDone = (AnimationDrawable) refreshStateImageView.getDrawable();
                animationDrawableDone.stop();
                break;
        }
    }
