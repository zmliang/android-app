...
public class MyAlertDialog {
    ...
    public MyAlertDialog setPositiveButton(String text, final boolean isDismiss, final OnClickListener listener) {
        showPosBtn = true;
        if ("".equals(text)) {
            btn_pos.setText(context.getString(R.string.action_positive));
        } else {
    ...
    public MyAlertDialog setNegativeButton(String text, final OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            btn_neg.setText(context.getString(R.string.action_negative));
        } else {
