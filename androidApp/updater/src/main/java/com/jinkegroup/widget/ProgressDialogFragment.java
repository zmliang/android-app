...
public class ProgressDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public void setProgress(float progress) {
        ...
        //更新已下载多少兆字节
        mTvProgressMsg.setText(mFormat.replace("%1f", JavaUtils.formatFloat2String(mTaskFinished, 2)).replace("%2f", JavaUtils.formatFloat2String(mTaskTotal, 2)));
    }
