...
import com.jinkegroup.supportlib.util.ScreenSizeUtil;
    ...
    private Bitmap getDefaultCover(Type type) {
        switch (type) {
            ...
            case ROUND:
                ...
                bitmap = ImageUtils.resizeImage(bitmap, ScreenSizeUtil.getDeviceWidth(AppApplication.getInstance()) / 2,
                        ScreenSizeUtil.getDeviceWidth(AppApplication.getInstance()) / 2);
                return bitmap;
            default:
