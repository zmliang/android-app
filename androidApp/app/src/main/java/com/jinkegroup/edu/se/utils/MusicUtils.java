...
import com.jinkegroup.edu.se.utils.data.Music;
import com.jinkegroup.supportlib.util.ParseUtils;
import com.jinkegroup.supportlib.util.SystemUtils;
...
public class MusicUtils {
    ...
    public static List<Music> scanMusic(Context context) {
        ...
        long filterSize = 0;//ParseUtils.parseLong(Preferences.getFilterSize()) * 1024;
        long filterTime = 0;//ParseUtils.parseLong(Preferences.getFilterTime()) * 1000;
